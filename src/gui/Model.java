...
public class Model {
    ...
    public static Boolean validarDriver(String driver){
        return driver.contains("chromedriver");
    }

    public static String matarProceso() {
        String mensaje = " ¡Eliminar proceso manualmente!";
